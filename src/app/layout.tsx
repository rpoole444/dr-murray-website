...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'website', title: 'Rob Murray — Trumpet', description: 'Trumpet artist, educator, and conductor.', images: ['/og.png'] },
  twitter: { card: 'summary_large_image', title: 'Rob Murray — Trumpet', description: 'Trumpet artist, educator, and conductor.', images: ['/og.png'] },
